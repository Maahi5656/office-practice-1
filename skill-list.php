                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="skill-update.php?update=<?php echo $row['ID']; ?>" class="btn btn-warning">Update</a>
                                                            <a href="skill-delete.php?delete=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete</a>
                                                        </td>                                                        
                                                    </tr>
