                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php if(isset($_SESSION['response']) && $_SESSION['type']){ ?>
                                         <span class="text-<?php echo $_SESSION['type']; ?>">
                                      ...
                                      <?php  }unset($_SESSION['response']); ?>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0;" cellspacing="0" width="100%">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Image</th>
                                                    <th>name</th>
                                                    <th colspan="1" style="width:250px;">Details</th>
                                                    <th>Link</th>
                                                    <td>Action</td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td>
                                                            <img src="<?php echo $row['image']; ?>" style="width:20px; height: 20px;" alt="">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="portfolio-update.php?update=<?php echo $row['ID']; ?>" class="btn btn-warning">Update</a>
                                                            <a href="portfolio-delete.php?delete=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete</a>
                                                        </td>                                                        
                                                    </tr>
